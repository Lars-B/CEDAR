...
#SBATCH --array=1-10
#SBATCH --output=/<HIDDEN>/CEDAR/experiments_hc/log/yeast/yeast_%a.out
#SBATCH --error=/<HIDDEN>/CEDAR/experiments_hc/log/yeast/yeast_%a.err
...
python ${CEDAR_DIR}/src/CEDAR.py HOP_hc \
       --fasta_path ${EXP_DIR}/data/yeast.fasta \
       --DNA_model "GTR" \
