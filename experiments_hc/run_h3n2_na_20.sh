...
#SBATCH --array=1-10
#SBATCH --output=/scratch/chauvec/CEDAR/CEDAR/experiments_hc/log/h3n2_na_20/h3n2_na_20_%A_%a.out
#SBATCH --error=/scratch/chauvec/CEDAR/CEDAR/experiments_hc/log/h3n2_na_20/h3n2_na_20_%A_%a.err
...
RES_OUT=${EXP_DIR}/results/h3n2_na_20/h3n2_na_20_${SLURM_ARRAY_TASK_ID}.csv
