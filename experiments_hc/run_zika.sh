...
#SBATCH --array=1-10
#SBATCH --output=/scratch/chauvec/CEDAR/CEDAR/experiments_hc/log/zika/zika_%A_%a.out
#SBATCH --error=/scratch/chauvec/CEDAR/CEDAR/experiments_hc/log/zika/zika_%A_%a.err
...
RES_OUT=${EXP_DIR}/results/zika/zika_${SLURM_ARRAY_TASK_ID}.csv
